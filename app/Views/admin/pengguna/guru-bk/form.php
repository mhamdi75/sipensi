...
<h1 class="h3 mb-3">FORM PENGGUNA GURU BK</h1>
<div class="row">
     <div class="col-12">
          <div class="card">
               <div class="card-header">
                    <a href="<?= base_url('admin/pengguna/guru-bk') ?>" class="btn btn-danger"><i class="align-middle me-1" data-feather="arrow-left"></i> KEMBALI KE DATA</a>
               </div>
               <div class="card-body">
                    <form action="<?= isset($data) ? base_url('admin/pengguna/guru-bk/ubah/' . $data->id) : base_url('admin/pengguna/guru-bk/tambah') ?>" method="post">
                         <div class="row mb-3">
